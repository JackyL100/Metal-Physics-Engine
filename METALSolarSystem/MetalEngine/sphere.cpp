...
Sphere::Sphere(float size_, simd::float3 center_) : Shape(size_, center_)
{
    
}

shader_types::InstanceData Sphere::getWorldToScreenTransform(simd::float3 cameraPosition)
{
